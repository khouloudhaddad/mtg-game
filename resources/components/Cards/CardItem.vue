<template>
    <div class="card position-relative col-md-3 mb-3 no_bg unbordered">
        <img :src="imageUrl" class="card-img-top" :alt="name" v-if="imageUrl" />
        <img
            src="http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=129711&amp;type=card"
            class="card-img-top"
            :alt="name"
            v-else
        />
        <div class="card-body px-2 bg-light">
            ...
            <ul class="list-unstyled">
                ...
                <li><strong>Type: </strong> {{ originalType }}</li>
                <li><strong>Mana Cost: </strong> {{ manaCost }}</li>
